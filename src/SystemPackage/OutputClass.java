...
public class OutputClass {
    ...
    public static void printLogin() throws InterruptedException {
        ...
        System.out.println("* " + "\t".repeat(5) + "SystemPackage.Library" + "\t".repeat(6) + "*");
        System.out.println("* " + "\t".repeat(12) + "*");
        System.out.println("*".repeat(49));
    ...
    public static void printMainOperation() throws InterruptedException {
        ...
        System.out.println("*  1) Manage MemberPackage.Members." + "\t".repeat(7) + "*");
    ...
    public static void manageMembers() throws InterruptedException {
        System.out.println("*".repeat(15)
                + Color_PURPLE + " Manage The MemberPackage.Members " + Color_RESET
                + "*".repeat(14));
        ...
        System.out.println("*  3) Show All MemberPackage.Members in System" + "\t".repeat(4) + "*");
        System.out.println("*  4) Show MemberPackage.Members who Borrowed Artificial\t\t*\n" +
                "\t  intelligence ItemsPackage.Books" + "\t".repeat(6) + "*");
        System.out.println("*  5) Show MemberPackage.Members who Late To Return ItemsPackage.Item \t\t*");
        System.out.println("*  6) Show MemberPackage.Members who Borrow Specific Book\t\t*\n" +
    ...
    public static void manageItems() throws InterruptedException {
        ...
        System.out.println("*  3) Search for ItemsPackage.Item." + "\t".repeat(7) + "*");
        System.out.println("*  4) Show Project with specific Academic Year.\t*");
        System.out.println("*  5) Show All ItemsPackage.Books." + "\t".repeat(6) + "*");
        System.out.println("*  6) Show All Borrowed ItemsPackage.Books." + "\t".repeat(5) + "*");
        System.out.println("*  7) Show All Available ItemsPackage.Projects within"
                + "\t".repeat(2)
        ...
        switch (HelperClass.tempIntInput) {
            ...
            case 5:
                ...
                break;
            case 6:
//Show All Borrowed ItemsPackage.Books
                break;
            case 7:
                //Todo View All available ItemsPackage.Projects within Specific Specialization
                break;
    ...
    public static void loanAndReturn() throws InterruptedException {
        System.out.println("*".repeat(13)
                ...
                + "*".repeat(13));
        System.out.println("* Please Select The Operations :" + "\t".repeat(4) + "*");
        System.out.println("*  1) Loan an ItemsPackage.Item" + "\t".repeat(8) + "*");
        System.out.println("*  2) Return an ItemsPackage.Item" + "\t".repeat(7) + "*");
        System.out.println("*  0) Go Back" + "\t".repeat(9) + "*");
        Thread.sleep(500);
        System.out.print(Color_YELLOW + "*  Enter -->  " + Color_RESET);
        HelperClass.tempIntInput = HelperClass.cin.nextInt();
