...
public class OutputClass {
  ...
  public static void printLogin() throws InterruptedException {
    ...
    System.out.println(
        Color_YELLOW + "*\t\t⚠️ Please Confirm Authentication ⚠️\t\t*" + Color_RESET);
    System.out.println("*".repeat(49));
  ...
  public static void manageMembers() throws InterruptedException {
    System.out.println(
        "*".repeat(15) + Color_PURPLE + " Manage The Members " + Color_RESET + "*".repeat(14));
    ...
    System.out.println(
        "*  4) Show Members who Borrowed Artificial\t\t*\n"
            + "\t  intelligence Books"
            + "\t".repeat(6)
            + "*");
    System.out.println("*  5) Show Members who Late To Return Item \t\t*");
    System.out.println(
        "*  6) Show Members who Borrow Specific Book\t\t*\n"
  ...
  public static void manageItems() throws InterruptedException {
    System.out.println(
        "*".repeat(15) + Color_PURPLE + " Manage The Items " + Color_RESET + "*".repeat(16));
    System.out.println("* Please Select The Operations :" + "\t".repeat(4) + "*");
...
break;
  ...
  public static void loanAndReturn() throws InterruptedException {
    System.out.println(
        "*".repeat(13) + Color_PURPLE + " Loan And Return Items " + Color_RESET + "*".repeat(13));
    System.out.println("* Please Select The Operations :" + "\t".repeat(4) + "*");
